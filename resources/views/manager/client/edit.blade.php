    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                @endif
                <form method="post" action="{{route('update_client')}}" enctype="multipart/form-data">
                    @csrf
                <!--begin::Row-->
                <div class="row">
                    <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_name" required
                                                           ...
                                                           placeholder="Client name" value="{{$client->client_name ?? old('client_name')}}">
                                                    @error('client_name')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_email" required
                                                           ...
                                                           placeholder="Client email" value="{{$client->client_email ?? old('client_email')}}">
                                                    @error('client_email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" name="client_phone" required
                                                           ...
                                                           value="{{$client->client_phone ?? old('client_phone')}}">
                                                    @error('client_phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
