                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="guard_name" required
                                                           ...
                                                           placeholder="Guard name" value="{{$guard->guard_name ?? old('guard_name')}}">
                                                    @error('guard_name')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="guard_email" required
                                                           ...
                                                           placeholder="Guard email" value="{{$guard->guard_email ?? old('guard_email')}}">
                                                    @error('guard_email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" name="guard_phone" required
                                                           ...
                                                           value="{{$guard->guard_phone ?? old('guard_phone')}}">
                                                    @error('guard_phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="guard_type" required>
                                                        <option value="1" {{$guard->guard_type == 1 ? 'selected' : ''}}>Regular Guard</option>
                                                        <option value="0" {{$guard->guard_type == 0 ? 'selected' : ''}}>Dispatch Guard</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="per_hour" required
                                                           ...
                                                           placeholder="15" value="{{$guard->per_hour ?? old('per_hour')}}">
                                                    @error('per_hour')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="guard_license_id" required
                                                               ...
                                                               placeholder="Guard license ID" value="{{$guard->guard_license_id ?? old('guard_license_id')}}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="guard_license_expiry" required
                                                              ...
                                                              placeholder="Guard License Expiry" value="{{$guard->guard_license_expiry ?? old('guard_license_expiry')}}">
                                ...
                                <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Security Guard License <small>(Front)</small>
                                                        @if($guard->driving_license_image != "")
                                                        <a target="_blank" href="{{$guard->driving_license_image}}" class="btn btn-primary btn-sm">View</a>
                                                        @endif
                                                    </label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Photo ID <small>(Front)</small>
                                                        @if($guard->photo_id_image != "")
                                                            <a target="_blank" href="{{$guard->photo_id_image}}" class="btn btn-primary btn-sm">View</a>
                                                        @endif
                                                    </label>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-inline">
                                                        <label class="checkbox checkbox-primary">
                                                            <input type="radio" {{$guard->driving_license == "no" ? 'checked' : ''}} value="no" class="driving_license" required name="driving_license">No
                                                            <span></span></label>
                                                        <label class="checkbox checkbox-success">
                                                            <input type="radio" {{$guard->driving_license == "yes" ? 'checked' : ''}} value="yes" required class="driving_license" name="driving_license">Yes
                                                            <span></span></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="driving_license_id"
                                                           {{$guard->driving_license == "yes" ? 'required' : ''}}
                                                           {{$guard->driving_license == "yes" ? '' : 'disabled'}}
                                                           class="form-control @error('driving_license_id') is-invalid @enderror"
                                                           placeholder="Driving license ID" value="{{$guard->driving_license_id ?? old('driving_license_id')}}">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    value="{{$guard->driving_license_expiry ?? old('driving_license_expiry')}}">
                            ...
                            <div class="col-lg-12">
                                <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <!--end::Header-->
                                                    ...
                                                    <div class="form-group">
                                                        <label>Are you available to work?</label>
                                                            <select class="form-control select_2_custom work_availability" required name="work_availability">
                                                                ...
                                                                <option {{$guard->work_availability == $w ? 'selected' : ''}}>{{$w}}</option>
                                                                    @endforeach
                                                            </select>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="available_start_date" required
                                                               ...
                                                               placeholder="YYYY-MM-DD" value="{{$guard->available_start_date ?? date('Y-m-d')}}">
                                                            ...
                                                            @foreach($days['morning'] as $x => $d)
                                                                <td>
                                                                    @if($x == 0)
                                                                        ...
                                                                        <input type="checkbox" {{$guard->isAvailable('Morning',$d) ? "checked" : ''}} name="morning[]" value="{{$d}}">
                                                            ...
                                                            @foreach($days['afternoon'] as $x => $d)
                                                                <td>
                                                                    @if($x == 0)
                                                                        {{$d}}
                                                                    @else
                                                                        <input {{$guard->isAvailable('Evening',$d) ? "checked" : ''}} type="checkbox" name="evening[]" value="{{$d}}">
                                                                    @endif
                                                                </td>
                                                            @endforeach
                                                        </tr>
                                                            ...
                                                            @foreach($days['night'] as $x => $d)
                                                                <td>
                                                                    @if($x == 0)
                                                                        {{$d}}
                                                                    @else
                                                                        <input {{$guard->isAvailable('Night',$d) ? "checked" : ''}} type="checkbox" name="night[]" value="{{$d}}">
                                                                    @endif
                                                                </td>
                                                            @endforeach
                                                        </tr>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" class="btn btn-warning">Update guard</button>
                                        </div>
